...
// Category options for Fashion products
...
function FashionInventory() {
  ...
  // Filter only fashion/accessories products
  const fashionProducts = inventory.filter(product => categoryTypes.fashion.includes(product.category))

  // Get available sizes based on category (fashion items often don't have sizes)
  const getAvailableSizes = (category) => {
    ...
    return siteConfig?.productSizes?.[category] || ['One Size']
  }
    ...
    <div className="inventory-page">
      ...
      <div className="page-header">
        <div className="header-left">
          ...
          <p>{fashionProducts.length} products total</p>
        </div>
        <button className="btn btn-primary" onClick={() => navigate('/admin/add-product?type=fashion')}>
          <FiPlus />
          Add Fashion Product
        </button>
      </div>
      ...
      <div className="table-container glass-card">
        ...
        {filteredProducts.length === 0 && (
          <div className="no-results">
            <p>No fashion products found. Add your first accessory!</p>
          </div>
        )}
        ...
        >
          ...
          >
            <div className="modal-header">
                <h3>{editingProduct ? 'Edit Fashion Product' : 'Add New Fashion Product'}</h3>
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group full-width">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="input-field"
                      placeholder="/images/fashion/product-1.jpg"
                    />
                    <div className="file-upload">
                      <input
                        ...
                        id="fashion-main-image-file"
                      />
                      <label htmlFor="fashion-main-image-file" className="file-label">
                            ...
                            <div key={index} className="variant-image-row">
                              ...
                              <div className="file-upload compact">
                                <input
                                  ...
                                  id={`fashion-variant-file-${index}`}
                                />
                                <label htmlFor={`fashion-variant-file-${index}`} className="file-label">
                                  Camera / device
                                </label>
                              </div>
                  ...
                  {formData.category && (
                    <div className="form-group full-width">
                      ...
                      <small className="size-hint">Click to toggle sizes/options available for this product</small>
                    </div>
                  )}
                </div>
...
export default FashionInventory
