...
// Category options for Kids products
const kidsCategories = [
  ...
  { id: 'kids-party', name: 'Kids Party Wear' }
]
    ...
    <div className="inventory-page">
      ...
      <div className="page-header">
        <div className="header-left">
          ...
          <p>{kidsProducts.length} products total</p>
        </div>
        <button className="btn btn-primary" onClick={() => navigate('/admin/add-product?type=kids')}>
          <FiPlus />
          Add Kids Product
        </button>
      </div>
      ...
      <div className="filters-bar glass-card">
        ...
        >
          <option value="">All Kids Categories</option>
      ...
      <div className="table-container glass-card">
        ...
        {filteredProducts.length === 0 && (
          <div className="no-results">
            <p>No kids products found. Add your first kids product!</p>
          </div>
        )}
        ...
        >
          ...
          >
            <div className="modal-header">
              <h3>{editingProduct ? 'Edit Kids Product' : 'Add New Kids Product'}</h3>
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group full-width">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="input-field"
                      placeholder="/images/kids/product-1.jpg"
                    />
                    <div className="file-upload">
                      <input
                        ...
                        id="kids-main-image-file"
                      />
                      <label htmlFor="kids-main-image-file" className="file-label">
                            ...
                            <div key={index} className="variant-image-row">
                              ...
                              <div className="file-upload compact">
                                <input
                                  ...
                                  id={`kids-variant-file-${index}`}
                                />
                                <label htmlFor={`kids-variant-file-${index}`} className="file-label">
                                  Camera / device
                                </label>
                              </div>
                  ...
                  {formData.category && (
                    <div className="form-group full-width">
                      <label>Available Sizes (Age Groups)</label>
